describe("Task API - DELETE Task By Id", () => {
    ...
    describe("Failed cases", () => {
        it("should fail if the task is deleted by admin", () => {
            cy.request({
                method: "DELETE",
                url: `${url}/${id.task}`, 
                headers: {
        ...
        it("should fail if the task not found", () => {
            cy.request({
                method: "DELETE",
                ...
                cy.expectDefaultResponseProps(res, 404, 'Task not found')
            })
        })
    ...
    describe("Success cases", () => {
        it("should delete task successfully with valid id", () => {
            cy.request({
                method: "DELETE", 
                url: `${url}/${id.task}`, 
                headers: {
                ...
                cy.expectDefaultResponseProps(res, 200, 'Delete task successful')
            })
        })
    })
})